...
async def post_graph_invoke(input_data: InputData):
    """
    Send question and answer to the app so that it can evaluate and generate a new question.
    :param input_data:  details regarding, user, user_id, question, answer
    :return: details regarding, policy violation, new question to be answered, number of question answered
    """
...
async def get_evaluation(user_id: str):
    """
    Get evaluated answers and marks for given uuid.
    :param user_id: unique id generated by the call of the api
